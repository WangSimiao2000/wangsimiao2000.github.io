...
![搜索Buffer Visualization文件夹](/assets/posts/在GBuffer%20Visualization中添加新的工具/01.png)

2. **新建材质球**
   - 右键点击，选择“Create Basic Asset”中的“Material”，命名为`Diffuse Color`。

![新建材质球](/assets/posts/在GBuffer%20Visualization中添加新的工具/02.png)

3. **打开材质编辑器**
   - 双击新创建的材质球，打开材质编辑器。

![材质编辑器](/assets/posts/在GBuffer%20Visualization中添加新的工具/03.png)
...
![材质编辑器蓝图](/assets/posts/在GBuffer%20Visualization中添加新的工具/04.png)

   - 使用`Multiply`节点实现乘法，使用`OneMinus`节点实现`1 - x`。

![使用Multiply节点](/assets/posts/在GBuffer%20Visualization中添加新的工具/05.png)
...
![搜索引擎源码](/assets/posts/在GBuffer%20Visualization中添加新的工具/06.png)
...
![找到相应选项](/assets/posts/在GBuffer%20Visualization中添加新的工具/07.png)

   - 选中后会出现如下效果，表明工具添加成功。

![查看效果](/assets/posts/在GBuffer%20Visualization中添加新的工具/08.png)
